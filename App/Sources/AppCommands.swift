...
struct AppCommands: Commands {
    ...
    var body: some Commands {
        ...
        // Extend the built-in View menu; a CommandMenu would create a second one.
        // Keep these actions in sync with the column headers and search options.
        ...
        CommandGroup(replacing: .help) {
            Button("Everyseek Help") { Self.open("https://github.com/iruri-labs/Everyseek") }
            Button("Report an Issue…") { Self.open("https://github.com/iruri-labs/Everyseek/issues/new") }
        }
    }
